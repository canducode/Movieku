...
class MoviekuRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): MoviekuRepository =
            instance ?: synchronized(this) {
                instance ?: MoviekuRepository(remoteData, localData, appExecutors)
            }
    }
