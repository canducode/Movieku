...
data class DetailTVShowResponse(
	...
	val genres: List<GenresTVShowItem>,

	@field:SerializedName("popularity")
	val popularity: Double,

	@field:SerializedName("production_countries")
	val productionCountries: List<ProductionCountriesTVShowItem>,
	...
	val spokenLanguages: List<SpokenLanguagesTVShowItem>,

	@field:SerializedName("production_companies")
	val productionCompanies: List<ProductionCompaniesTVShowItem>,
...
@Parcelize
data class ProductionCompaniesTVShowItem(
...
@Parcelize
data class ProductionCountriesTVShowItem(
...
@Parcelize
data class SpokenLanguagesTVShowItem(
